        ...
        while (true) {
            ...
            try {
                ...
                if (eleccion == 1 || eleccion == 2 || eleccion == 3) {
                    ...
                    System.out.println("⚠️ Opción inválida. Solo puedes elegir entre 1, 2 o 3.");
                }
            } catch (InputMismatchException e) {
                System.out.println("⚠️ Entrada no válida. Por favor, introduce un número (1, 2 o 3).");
